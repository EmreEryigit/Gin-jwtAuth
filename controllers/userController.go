...
func VerifyPassword(suppliedPassword string, foundPassword string) (bool, string) {
	err := bcrypt.CompareHashAndPassword([]byte(foundPassword), []byte(suppliedPassword))
	check := true
	msg := ""
	if err != nil {
